...
void setup() {
  ...
  pinMode(13, OUTPUT);///home/jonny/Downloads/synchronization_controller/3. Action Editting Tutorial/2. Sencond Development（Optional）/Lesson 2 Burn Firmware Program/Factory Firmware Program/Sync/Sync.ino
  delay(1000);
}
